...
internal class PhilologyResources(baseResources: Resources, overrideConfig: Configuration? = null) :
    Resources(baseResources.assets, baseResources.displayMetrics, overrideConfig?: baseResources.configuration) {
